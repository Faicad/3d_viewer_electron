...
for (const file of files) {
  ...
  // (GLTFLoader.js:1891 `chunkIndex += chunkLength` — no padding handling).
  // To work around this bug, ensure JSON chunk length is 4-byte aligned by
  // padding the JSON content itself with whitespace (valid per JSON spec).
