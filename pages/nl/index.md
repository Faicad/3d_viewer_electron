...
hero:
  ...
  text: 'Cross-platform 3D-modelviewer'
  tagline: 'Gratis en open-source desktopapplicatie voor het bekijken van 33+ 3D-bestandsformaten, gebouwd met Electron + Three.js'
  actions:
    - theme: brand
      text: Aan de slag
