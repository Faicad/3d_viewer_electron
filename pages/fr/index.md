...
hero:
  ...
  text: 'Visualiseur de modèles 3D multiplateforme'
  tagline: 'Application de bureau gratuite et open-source pour visualiser plus de 27 formats de fichiers 3D, construite avec Electron + Three.js'
  actions:
    - theme: brand
      text: Commencer
