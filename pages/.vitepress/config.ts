    ...
    [`${prefix}/toolbar/`]: [
      {
        text: navT.toolbar,
        items: [
          { text: t.openFile, link: `${prefix}/toolbar/open-file` },
          { text: t.axisSwitch, link: `${prefix}/toolbar/axis-switch` },
          { text: t.perspectiveMode, link: `${prefix}/toolbar/perspective-mode` },
          { text: t.materialManager, link: `${prefix}/toolbar/material-manager` },
          { text: t.renderSettings, link: `${prefix}/toolbar/render-settings` },
          { text: t.animationPlayer, link: `${prefix}/toolbar/animation-player` },
          { text: t.bedManagement, link: `${prefix}/toolbar/bed-management` },
          { text: t.history, link: `${prefix}/toolbar/history` },
          { text: t.modelInfo, link: `${prefix}/toolbar/model-info` },
          { text: t.fullscreen, link: `${prefix}/toolbar/fullscreen` },
          { text: t.sidebarControl, link: `${prefix}/toolbar/sidebar-control` },
          { text: t.cacheManagement, link: `${prefix}/toolbar/cache-management` },
          { text: t.systemSettings, link: `${prefix}/toolbar/system-settings` },
        ],
      },
    ],
    [`${prefix}/formats/`]: [
