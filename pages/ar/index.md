...
hero:
  ...
  text: 'عارض النماذج ثلاثية الأبعاد متعدد المنصات'
  tagline: 'تطبيق سطح مكتب مجاني ومفتوح المصدر لعرض أكثر من 27 تنسيقًا من ملفات ثلاثية الأبعاد، مبني على Electron + Three.js'
  actions:
    - theme: brand
      text: ابدأ
