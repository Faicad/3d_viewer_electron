...
hero:
  ...
  text: 'Visualizzatore di modelli 3D multipiattaforma'
  tagline: 'Applicazione desktop gratuita e open-source per visualizzare oltre 27 formati di file 3D, costruita con Electron + Three.js'
  actions:
    - theme: brand
      text: Inizia
